<?php
    class PremiumGroup extends Module
    {
        ...
        {
            if (!Configuration::updateValue('PG_ID1', '4') ||
                !Configuration::updateValue('PG_ID2', '3') ||
                !Configuration::updateValue('PG_PID1', '1') ||
                !Configuration::updateValue('PG_PID2', '2') ||
                !Configuration::updateValue('PG_PID3', '3') ||
                !Configuration::updateValue('PG_PID4', '4') ||
                !Configuration::updateValue('PG_T1', '1') ||
                !Configuration::updateValue('PG_T2', '7') ||
                !Configuration::updateValue('PG_T3', '30') ||
                !Configuration::updateValue('PG_T4', '365'))
                return false;
            return true;
        }
