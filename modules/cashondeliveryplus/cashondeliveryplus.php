   ...
   public   function uninstall()
	...
	public function hookPayment($params)
	{
		...
		$smarty->assign(array(
         ...
         $amountPaid=$this->context->cart->getOrderTotal(false, Cart::BOTH_WITHOUT_SHIPPING); 
         if($this->feefree > 0 && $amountPaid >  Tools::convertPrice($this->feefree)) {
             $smarty->assign(array(
            'dobirecne' => $this->l('Free!')));  
         } else {
                  $smarty->assign(array(
            'dobirecne' => Tools::displayPrice (Tools::convertPrice($this->fee))));
         }
  ...
  /**
    ...
    */
            ...
            foreach ($package_list as $id_address => $packageByAddress)
                foreach ($packageByAddress as $id_package => $package)
                {
                    ...
                    $order->total_discounts = $order->total_discounts_tax_incl;
                      ...
                      /////////////////////////////////////////////////////////////  
                   if($this->feefree > 0 && $order->total_products > Tools::convertPrice($this->feefree)) {
                        $fee=0;     
                     }
                     else {
    ...
    {   
        ...
        '.$this->l('Free from:  ').'<input  name="COD_FEEFREE" value="'.Tools::convertPrice($this->feefree).'" />   '.$currency->sign.'   <br />' 
        .$this->l('0 = always pay a fee').'    <br />';
        
        
            $this->_html .='<br /><br />'.$this->l('Allowed carriers, leave empty for all').'<br />'.$this->fetchCarriers($this->allowed_carriers).'<br /> 
