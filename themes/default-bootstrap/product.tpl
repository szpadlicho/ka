...
<div itemscope itemtype="https://schema.org/Product">
	...
	<div class="primary_block row">
		{if !$content_only}
			<div class="container">
				<div id="product-top-hr" class="top-hr"></div>
			</div>
		{/if}
				...
				<form method="post" action="{$customizationFormTarget}" enctype="multipart/form-data" id="customizationForm" class="clearfix">
					{if $product->text_fields|intval}
						<div class="customizableProductsText ">
							<h5 class="product-heading-h5">{l s='Pytanie'}</h5>
							<ul id="text_fields">
							...
							{foreach from=$customizationFields item='field' name='customizationFields'}
								{if $field.type == 1}
									<li class="customizationUploadLine{if $field.required} required{/if}">
										...
										<textarea name="textField{$field.id_customization_field}" class="form-control customization_block_input" id="textField{$customizationField}" rows="5" cols="">{strip}
                    ...
                    <p class="infoCustomizable">
						{l s='Po napisaniu pytania nie zapomnij go zapisać, następnie dodaj je do koszyka.'}
					</p>
                    <p class="infoCustomizable">
                    ...
                    {if $product->uploadable_files|intval}
						<div class="customizableProductsFile">
							<h5 class="product-heading-h5">{l s='Plik'}</h5>
					...
					<p id="customizedDatas">
						...
						<button class="button btn btn-default button button-small button-save-question" name="saveCustomization">
							<span>{l s='Save'}</span>
						</button>
